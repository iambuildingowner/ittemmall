...
`ittemmall.com` 상위 쇼핑몰 프로젝트입니다. 현재 결제 심사 방향은 잇템몰 본몰 기준 Toss PG입니다. 네이버페이 가맹점 신청/연동은 별도 `마르세 스포츠` 프로젝트에서 진행합니다.

## Current Structure

- Home: 상품 탐색, 옵션 선택, 주문 흐름, 정책/사업자정보 진입
- Payment: 주문 저장, Toss PG 심사 placeholder, 관리자 주문 확인, 결제 상태 복귀
