...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--notify-email", default="staysiaofficial@gmail.com", help="Order/click notification recipient email.")
    parser.add_argument("--notify-from", default="no-reply@ittemmall.com", help="Optional order notification sender email.")
    parser.add_argument("--enable-notify", dest="enable_notify", action="store_true", default=True, help="Set ITTEMMALL_NOTIFY_ENABLED=1.")
    parser.add_argument("--disable-notify", dest="enable_notify", action="store_false", help="Set ITTEMMALL_NOTIFY_ENABLED=0.")
