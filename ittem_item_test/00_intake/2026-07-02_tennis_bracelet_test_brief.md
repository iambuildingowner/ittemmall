...
- 추가 확인 시각: 2026-07-02 20:55 KST
- 상태: 초안 저장 완료, 실제 게시 시도했으나 계정 전체 임시 저장 오류 초안 때문에 최종 게시 보류
- 캠페인: `잇템몰_아이템검증`
- 광고 세트: `테니스팔찌_KR_F25-54_데일리주얼리_9980`
- 광고 세트 설정:
  - 지역: 대한민국
...
- 재개 조건:
  - Meta 광고 관리자에서 계정 전체 임시 저장 오류 초안을 삭제하거나 수정해도 되는지 사용자 승인을 받는다.
  - 또는 Meta UI에서 현재 테니스 팔찌 광고만 단독 게시할 수 있는 경로가 보이면 해당 경로로 게시한다.
